...
Watch the StarterKit overview video to see how it works:

<!-- embed: https://youtu.be/uCQcxhVUsdc -->

(If you're reading this on GitHub or another renderer without embed support: [watch it here](https://youtu.be/uCQcxhVUsdc).)
